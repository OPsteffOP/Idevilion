...
#include <core/utils/memory/stl/AWSMap.h>
#include <utility>
...
namespace Model
{
  ...
  public:
     ...
     * developer-defined information related to the player. Amazon Web Services does
     * not use this data, so it can be formatted as needed for use in the game. Any
     * player data strings for player IDs that are not included in the
