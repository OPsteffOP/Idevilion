...
#include <gamelift/model/GameSessionStatus.h>
#include <gamelift/model/GameSessionStatusReason.h>
#include <core/utils/memory/stl/AWSVector.h>
#include <gamelift/model/PlayerSessionCreationPolicy.h>
...
namespace Model
{
   ...
   * this time. Game session logs are retained for 14 days.</p> <p> <b>Related
