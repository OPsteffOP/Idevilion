...
namespace Model
{
   ...
   * groups.</b> </p> <p>An Amazon EC2 launch template that contains configuration
   ...
   * with <a>CreateGameServerGroup</a>. </p><p><h3>See Also:</h3>   <a
  ...
  public:
     ...
     * default is the first version created.</p>
     */
