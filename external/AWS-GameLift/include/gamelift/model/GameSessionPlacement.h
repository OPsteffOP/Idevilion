...
#include <gamelift/model/GameSessionPlacementState.h>
#include <core/utils/memory/stl/AWSVector.h>
#include <core/utils/DateTime.h>
#include <gamelift/model/GameProperty.h>
#include <gamelift/model/PlayerLatency.h>
#include <gamelift/model/PlacedPlayerSession.h>
#include <utility>
...
namespace Model
{
  ...
  public:
    ...
    /**
     * <p>A unique identifier for the game session. This value is set once the new game
