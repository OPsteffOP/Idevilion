...
#include <core/utils/threading/ReaderWriterLock.h>
#include <core/internal/AWSHttpResourceClient.h>
#include <core/auth/AWSCredentials.h>
#include <core/config/AWSProfileConfigLoader.h>
#include <core/client/RetryStrategy.h>
#include <memory>
