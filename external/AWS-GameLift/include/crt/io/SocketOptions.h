        ...
        namespace Io
        {
            ...
            class AWS_CRT_CPP_API SocketOptions
            {
              public:
                 ...
                 * @param keepAliveInterval: Duration, in seconds, between keepalive retransmissions, if acknowledgement
                 * of previous keepalive transmission is not received. If 0, then a default value is used.
                 */
                 ...
                 * 0, then a default value is used.
                 */
